...
public interface AnagraficaClientiService {
     ...
     */
    List<ClienteDto> cercaCliente(CriterioClienteDto criterio) throws SigebaException;
     ...
     * criterio passato.
     */
    List<ClienteDto> inserisciCliente(CriterioInserimentoClienteDto dto) throws SigebaException;
     ...
     */
    List<ClienteDto> cancellaCliente(CriterioCancellazioneClienteDto dtoCancellazione) throws SigebaException;
     ...
     * @throws it.iad.sigeba2.exception.SigebaException
     */
    List<ClienteDto> modificaCliente(CriterioModificaClienteDto modificaDto) throws SigebaException;
     ...
     * @throws it.iad.sigeba2.exception.SigebaException
     */
    Cliente leggiCliente(SimpleIdDto cliente) throws SigebaException;
